(function( $ ) {
	...
	/*
	 * 
	 * jquery.nameparser.js
	 * 
	 * ported to jQuery plugin by Robert Munn
	 * 
	 * https://github.com/robertdmunn/jQuery-Name-Parser
	 * 
	 */
	...
	function NameParse() {
		...
		NameParse.prototype.parse = function (fullastName) {
			...
			//now split out first and middle names
			...
			name.middleName = (middleName != "") ? middleName.trim() : "";
		...
		this.is_compound_lastName = function (word) {
			...
			var words = ['vere','von','van','de','del','della','di','da','pietro','vanden','du','st.','st','la','lo','ter', 'mac', 'mc'];
